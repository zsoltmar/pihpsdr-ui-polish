...
/* Size dialog to parent (e.g. 800x480) and pack body in a vertical scroll area. */
void pihpsdr_dialog_fit_parent(GtkWidget *dialog, GtkWidget *parent);
void pihpsdr_dialog_pack_scrolled_body(GtkWidget *dialog, GtkWidget *child);

/* Consistent spacing/margins for modal menu grids (label + control rows). */
void pihpsdr_modal_grid_defaults(GtkWidget *grid);
