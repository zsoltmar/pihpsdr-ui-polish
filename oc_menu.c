...
g_print("oc_menu: parent=%p\n",parent);
  ...
  /*
   * 22-column OC grid: column_spacing=10 alone adds 210 px of gaps,
   * which combined with the natural width of 22 check-buttons pushes
   * the grid past the viewport on the Pi's 800 px screen and forces
   * a horizontal scrollbar.  Tightening to 2 px recovers ~180 px --
   * enough to make the whole grid fit without horizontal overflow,
   * while still leaving visible space between columns.
   */
