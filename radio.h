...
//
/* Cairo resolves via fontconfig: apt install fonts-firacode fonts-firago (or fonts-fira-sans). */
#define DISPLAY_FONT "Fira Sans"
#define DISPLAY_FONT_MONO "Fira Code"
#define DISPLAY_FONT_SIZE1 8
#define DISPLAY_FONT_SIZE2 10
#define DISPLAY_FONT_SIZE3 12
#define DISPLAY_FONT_SIZE4 16
#define DISPLAY_FONT_SIZE5 20

#define SLIDERS_FONT "Fira Sans 10"
