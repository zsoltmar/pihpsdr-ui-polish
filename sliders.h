...
/* GtkOverlay: scale fills row; #pihpsdr_slider_inline_left + #pihpsdr_slider_inline_value over the track. */
GtkWidget *pihpsdr_labeled_scale_row(const char *text, GtkWidget *scale, GtkWidget **label_out,
    gboolean show_value_on_right);

extern void pihpsdr_fill_scale_install(GtkWidget *scale);
