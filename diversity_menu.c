...
void diversity_menu(GtkWidget *parent) {
  ...
  gtk_widget_set_name(gain_coarse_scale, "pihpsdr_fill_scale");
  gtk_scale_set_draw_value(GTK_SCALE(gain_coarse_scale), FALSE);
  gtk_widget_set_hexpand(gain_coarse_scale, TRUE);
  pihpsdr_fill_scale_install(gain_coarse_scale);
  ...
  gtk_widget_set_name(gain_fine_scale, "pihpsdr_fill_scale");
  gtk_scale_set_draw_value(GTK_SCALE(gain_fine_scale), FALSE);
  gtk_widget_set_hexpand(gain_fine_scale, TRUE);
  pihpsdr_fill_scale_install(gain_fine_scale);
  ...
  gtk_widget_set_name(phase_coarse_scale, "pihpsdr_fill_scale");
  gtk_scale_set_draw_value(GTK_SCALE(phase_coarse_scale), FALSE);
  gtk_widget_set_hexpand(phase_coarse_scale, TRUE);
  pihpsdr_fill_scale_install(phase_coarse_scale);
  ...
  gtk_widget_set_name(phase_fine_scale, "pihpsdr_fill_scale");
  gtk_scale_set_draw_value(GTK_SCALE(phase_fine_scale), FALSE);
  gtk_widget_set_hexpand(phase_fine_scale, TRUE);
  pihpsdr_fill_scale_install(phase_fine_scale);
