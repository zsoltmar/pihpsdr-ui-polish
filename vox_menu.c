...
void vox_menu(GtkWidget *parent) {
  ...
  gtk_widget_set_name(level, "pihpsdr_mic_meter");
...
//  gtk_widget_set_size_request (vox_scale, 300, 25);
  ...
  gtk_widget_set_name(vox_scale, "pihpsdr_fill_scale");
  gtk_scale_set_draw_value(GTK_SCALE(vox_scale), FALSE);
  pihpsdr_fill_scale_install(vox_scale);
  ...
  gtk_widget_set_name(vox_hang_scale, "pihpsdr_fill_scale");
  gtk_scale_set_draw_value(GTK_SCALE(vox_hang_scale), FALSE);
  pihpsdr_fill_scale_install(vox_hang_scale);
